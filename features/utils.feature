...
Remote file content
		...
		Then a file named "temp/download_file.localhost.txt" should exist

	Scenario: Download a file from server which does exist locally
		Given a file named "temp/download_file.localhost.txt" with:
		"""
Local file content
		"""
...
Remote file content
		"""
		When I successfully run `cap dev utils:download_file['download_file.txt']`
		Then the file "temp/download_file.localhost.txt" should contain exactly:
		"""
Remote file content
